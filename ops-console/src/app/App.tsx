      ...
      <section className="workspace">
        ...
        <section className="title-row">
          ...
          <div className="status-pill">
            <span className={isFetching ? 'pulse fetching' : 'pulse'} />
            {platformStatus?.phase ?? 'phase-0-bootstrap'}
          </div>
        </section>
        ...
        <section className="grid three-column">
          <article className="panel chart-panel">
            <div className="panel-heading">
              ...
              <span>Submitted vs reserved</span>
            </div>
            <ResponsiveContainer width="100%" height={210}>
              <AreaChart data={throughput} margin={{ left: -20, right: 8, top: 10, bottom: 0 }}>
                <CartesianGrid stroke="#e5e7eb" vertical={false} />
                <XAxis dataKey="day" tickLine={false} axisLine={false} />
                <YAxis tickLine={false} axisLine={false} />
                <Tooltip />
                <Area type="monotone" dataKey="orders" stroke="#2563eb" fill="#dbeafe" />
                <Area type="monotone" dataKey="reserved" stroke="#0f766e" fill="#ccfbf1" />
              </AreaChart>
            </ResponsiveContainer>
          </article>
          ...
          <article className="panel chart-panel">
            ...
            <ResponsiveContainer width="100%" height={210}>
              <BarChart data={backlog} margin={{ left: -20, right: 8, top: 10, bottom: 0 }}>
                <CartesianGrid stroke="#e5e7eb" vertical={false} />
